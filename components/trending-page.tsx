...
export function TrendingPage() {
  ...
  const [pnlToken, setPnlToken] = useState<string | null>(null)
              ...
              {isLoading ? (
                ...
                <tr key={token.id} className="border-b border-[#282828] hover:bg-[#1a1a1a]/50 transition-colors">
                  ...
                  <td className="py-3 px-4">
                      ...
                      <Button
                        size="sm"
                        className="bg-gray-800 hover:bg-gray-700 text-white px-2 py-1 text-xs h-6 ml-2 flex items-center"
                        onClick={() => {
                          setPnlToken(String(token.id))
                          setIsPnLOpen(true)
                        }}
                        title="Open PnL"
                      >
